...
(function() {
  ...
  flushRTMPMessages = function(stream, params) {
    var allSessions, buf, bufs, clientID, i, j, k, l, len1, len2, len3, len4, m, msgs, rtmpMessage, rtmpMessagesToSend, session;
    if (stream == null) {
    ...
    for (j = 0, len1 = allSessions.length; j < len1; j++) {
      session = allSessions[j];
      ...
      if (session.isWaitingForKeyFrame) {
        if (config.rtmpWaitForKeyFrame) {
          if (stream.isVideoStarted) {
            for (i = k = 0, len2 = rtmpMessagesToSend.length; k < len2; i = ++k) {
  ...
  RTMPSession = (function() {
    ...
    RTMPSession.prototype.pauseOrUnpauseStream = function(commandMessage, callback) {
      var doPause, ref;
      doPause = ((ref = commandMessage.objects[1]) != null ? ref.value : void 0) === true;
      if (doPause) {
        this.isPlaying = false;
    ...
    RTMPSession.prototype.handleAMFCommandMessage = function(commandMessage, callback) {
      ...
      switch (commandMessage.command) {
        ...
        case 'play':
          this.streamId = (ref2 = commandMessage.objects[1]) != null ? ref2.value : void 0;
    ...
    RTMPSession.prototype.handleData = function(buf, callback) {
      ...
      if (this.state !== SESSION_STATE_HANDSHAKE_DONE) {
        ...
        consumeNextRTMPMessage = (function(_this) {
          return function() {
            var acknowledgementMessage, audioData, bufferLength, commandMessage, dataMessage, dts, j, len1, newChunkSize, parseResult, pts, ref, results, rtmpMessage, stream, streamID, timestamp, userControlMessage, videoData;
            if (buf == null) {
              onConsumeAllPackets();
              return;
            }
  ...
  RTMPServer = (function() {
    ...
    RTMPServer.prototype.sendVideoPacket = function(stream, nalUnits, pts, dts) {
      var buf, compositionTimeMs, firstByte, hasKeyFrame, j, len1, message, nalUnit, nalUnitType, payloadLen, timestamp;
