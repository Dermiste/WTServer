...
(function() {
  ...
  api = {
    ...
    removeEmulationPreventionByte: function(nalUnit) {
      var emulPos, ref, ref1, searchPos;
      searchPos = 0;
      while (true) {
        ...
        [].splice.apply(nalUnit, [(ref = emulPos + 2), (emulPos + 2) - ref + 1].concat(ref1 = [])), ref1;
        searchPos = emulPos + 2;
      }
    },
