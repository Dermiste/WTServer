...
(function() {
  var CustomReceiver, DEBUG_INCOMING_PACKET_DATA, DEBUG_INCOMING_PACKET_HASH, DEFAULT_SERVER_NAME, Sequent, StreamServer, aac, avstreams, config, crypto, fs, h264, http, logger, net, packageJson, ref, rtmp, rtsp, serverName;
  ...
  StreamServer = (function() {
    ...
    StreamServer.prototype.onReceiveAudioAccessUnits = function(stream, accessUnits, pts, dts) {
      var accessUnit, i, j, len, md5, ptsPerFrame, results;
      ...
      for (i = j = 0, len = accessUnits.length; j < len; i = ++j) {
        ...
        results.push(this.rtmpServer.sendAudioPacket(stream, accessUnit, Math.round(pts + ptsPerFrame * i), Math.round(dts + ptsPerFrame * i)));
      }
      return results;
    };
